"""
Django settings for precocerto project.
...
SECRET_KEY = 'f96_s&gf&vz$_1vpgux9ue7(uy(edw=82)%ij@r3b*p5_)d^y#'
...
INSTALLED_APPS = [
    ...
    'api.apps.ApiConfig',
    'sitevendas.apps.SitevendasConfig',
]
...
WSGI_APPLICATION = 'precocerto.wsgi.application'
